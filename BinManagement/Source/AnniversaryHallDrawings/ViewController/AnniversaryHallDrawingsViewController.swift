...
class AnniversaryHallDrawingsViewController: UIViewController {
    var currentTrashcanId: Int? // 현재 선택된 trashcan의 id를 저장

    private lazy var header = AnniversaryHallDrawingsTabHeader(frame: .zero)
...
extension AnniversaryHallDrawingsViewController: UIScrollViewDelegate {
